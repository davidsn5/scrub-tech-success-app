-- Update the handle_new_user function to use 3-day trial instead of 5-day
...
BEGIN
  ...
  -- Insert subscriber with 3-day trial (except for admin and premium users)
