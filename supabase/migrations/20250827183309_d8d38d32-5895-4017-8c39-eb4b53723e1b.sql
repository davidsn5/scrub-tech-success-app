-- Update the handle_new_user function to include matt@gmail.com as an admin user
...
BEGIN
  ...
  IF NEW.email = 'davidsonnf@gmail.com' OR NEW.email = 'surgicaltechreview@gmail.com' OR NEW.email = 'matt@gmail.com' THEN
