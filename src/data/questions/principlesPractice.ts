...
export const principlesPracticeQuestions: Question[] = [
  ...
  {
    id: 3,
    question: "What is the first step in donning sterile gloves?",
    choices: [
      "Open the glove package",
      "Wash hands",
      "Put on gown",
      "Dry hands"
    ],
  ...
  {
    id: 4,
    question: "Which of the following is NOT a type of surgical scrub?",
    choices: [
      "Timed scrub",
  ...
  {
    id: 5,
    question: "What is the recommended duration for a surgical hand scrub?",
    choices: [
      "1 minute",
      "3-5 minutes",
      "10 minutes",
  ...
  {
    id: 6,
    question: "Which of the following is a common sterilization method?",
    choices: [
      "Boiling",
      "Autoclaving",
      "Freezing",
  ...
  {
    id: 7,
    question: "What is the minimum temperature for steam sterilization in an autoclave?",
    choices: [
      "121°C",
      "100°C",
      "150°C",
  ...
  {
    id: 8,
    question: "Which of the following is a chemical sterilant?",
    choices: [
      "Ethylene oxide",
      "Steam",
      "Dry heat",
  ...
  },
  {
    ...
    choices: [
      "To confirm patient identity and procedure",
      "To sterilize instruments",
  ...
  {
    id: 10,
    question: "Which of the following is a type of suture material?",
    choices: [
      "Silk",
      "Cotton",
      "Nylon",
  ...
  {
    id: 11,
    question: "What is the term for the process of closing a wound?",
    choices: [
      "Debridement",
      "Suturing",
      "Irrigation",
  ...
  {
    id: 12,
    question: "Which instrument is used to hold tissue during surgery?",
    choices: [
      "Scalpel",
      "Forceps",
      "Retractor",
  ...
  {
    id: 14,
    question: "Which of the following is a type of surgical dressing?",
    choices: [
      "Gauze",
      "Adhesive tape",
      "Occlusive dressing",
  ...
  {
    id: 15,
    question: "What is the primary goal of surgical draping?",
    choices: [
      "To keep the patient warm",
      "To maintain a sterile field",
      "To protect the surgical team",
      "To cover the instruments"
    ],
    correctAnswer: 1
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      "Blocks or counteracts another drug",
  ...
  },
  {
    ...
    choices: [
      ...
      "Works with another drug to boost effect",
  ...
  },
  {
    ...
    choices: [
      "Tolerance to a drug",
      "Dependence on the effect of a drug",
      "Antagonist effect",
      "Neutralizing acid"
    ],
    correctAnswer: 1
  ...
  },
  {
    ...
    choices: [
      ...
      "How long medication works",
      "How fast drug is administered",
      "How soon it peaks"
    ],
    correctAnswer: 1
  },
  ...
  },
  {
    ...
    choices: [
      "Directly",
      "Below table level",
      "12 inches above pitcher",
      "From sterile container"
    ],
    correctAnswer: 2
  },
  {
  ...
  {
    id: 223,
    question: "Which part of the respiratory system is the site of gas exchange?",
    choices: [
      "Bronchi",
      "Trachea",
      "Alveoli",
  ...
  {
    id: 239,
    question: "Which electrolyte is most important for nerve function?",
    choices: [
      "Calcium",
      "Potassium",
      "Sodium",
