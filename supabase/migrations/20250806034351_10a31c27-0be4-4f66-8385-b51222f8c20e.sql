-- Update the handle_new_user function to use 1-day trial instead of 3-day
...
BEGIN
  ...
  -- Insert subscriber with 1-day trial (except for admin and premium users)
